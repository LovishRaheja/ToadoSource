...
public class RegisterProfileFirebase {
    ...
    public static void saveDataToFirebase(String name, String mPhone1, String gender, String dob,String interest, String imgurL, final String mykey1, final UserSession sharedpref, final UserSettingsSharedPref userSettingsSharedPref, final Activity act) {
        ...
        u = new User(name, mPhone1, gender, dob, imgurL, interest);
