...
public class PersonalDetailsAct extends ToadoBaseActivity implements CalendarDatePickerDialogFragment.OnDateSetListener, ActivityCompat.OnRequestPermissionsResultCallback {
    ...
    private TextView tvDob,showInterest;
    private EditText etName,enterInterest;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        showInterest=(TextView)findViewById(R.id.showInterest);
    ...
    public void btnToMain(View view) {
        ...
        String gender = "nil";
        String interest=showInterest.getText().toString();
        if (rbmale.isChecked()) {
            gender = "male";
...
//        imgMeth();
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == RESULT_OK) {
            ...
            Glide.with(this).load(new File(result.getUri().getPath())).into(imgb);
    ...
    private void uploadImage(final String name, final String mPhone, final String gender, final String dob, Uri uri) {
        ...
        StorageReference profilepicref = FirebaseStorage.getInstance().getReference().child("profileImages").child(mykey).child(uri.getLastPathSegment());
        Bitmap bitmap = null;
        try {
        ...
        uploadTask
                .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        RegisterProfileFirebase.saveDataToFirebase(name, mPhone, gender, dob,interest, downloadUrl,mykey,sharedpref,userSettingsSharedPref,PersonalDetailsAct.this);
