...
public class CallHelper {
    ...
    public static void addCallToFirebase(String otherusrkey, Long id, String rectok) {
        ...
        DBREF.child("Users").child("UserVCAllLogs").child(otherusrkey).child(String.valueOf(id).toUpperCase()).child("receiverToken").setValue(rectok);
    }
...
//        }
        //also sending ProfileAct pic url and username of current user
