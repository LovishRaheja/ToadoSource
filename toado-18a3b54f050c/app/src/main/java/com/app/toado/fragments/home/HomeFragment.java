...
public class HomeFragment extends Fragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        laycoord = (LinearLayout) view.findViewById(R.id.coordinatorlayout);

        swipe=(SwipeRefreshLayout)view.findViewById(R.id.swipeData);
...
//            System.out.println("meteres = " + myloc.distanceTo(userLoc) + "distance in miles homefragment = " + distanceInMiles);
            ...
            DistanceUser distanceUser = new DistanceUser(key1, user.getName(), distanceInMiles,user.getProfpicurl());
