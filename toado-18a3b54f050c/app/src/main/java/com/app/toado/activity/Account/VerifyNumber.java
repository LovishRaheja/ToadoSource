...
import com.app.toado.activity.register.ChooseAct;
...
public class VerifyNumber extends ToadoBaseActivity implements ActivityCompat.OnRequestPermissionsResultCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (intent != null) {
            mPhoneNumber = intent.getStringExtra(AccountUpdate.INTENT_PHONENUMBER);
            final String method = intent.getStringExtra(AccountUpdate.INTENT_METHOD);
            mIsSmsVerification = method.equalsIgnoreCase(AccountUpdate.SMS);
    ...
    private void createVerification() {
        ...
        System.out.println(" create verification called enable input field set true");
        ...
        listener = new com.app.toado.activity.Account.VerifyNumber.MyVerificationListener();

        if (mIsSmsVerification) {
            System.out.println(" sms create verification called ");
            ...
            System.out.println(" call create verification called ");
    ...
    public void onSubmitClicked(View view) {
        ...
        if (!code.isEmpty()) {
            if (mVerification != null) {
                System.out.println("input code to send otp act" + code);
    ...
    public void onResendClicked(View view) {
        ...
        requestPermissions();
        if (mIsSmsVerification)
            Toast.makeText(com.app.toado.activity.Account.VerifyNumber.this, "Sending otp again, please wait.", Toast.LENGTH_SHORT).show();
        else
            Toast.makeText(com.app.toado.activity.Account.VerifyNumber.this, "Trying flash call again, please wait.", Toast.LENGTH_SHORT).show();
        ...
        if (enable) {
            ...
            input.setOnEditorActionListener(new EditText.OnEditorActionListener() {
                ...
                public boolean onEditorAction(TextView v, int actionId, KeyEvent event) {
                    ...
                    return cb.closeKeyb2(input, com.app.toado.activity.Account.VerifyNumber.this, v, actionId, event);
                }
    ...
    class MyVerificationListener implements VerificationListener {
        ...
        public void onVerified() {
            ...
            Query deleteQuery2 = DBREF_USER_MOBS.getRef().orderByChild("usermob").equalTo(phone);

            deleteQuery2.addListenerForSingleValueEvent(new ValueEventListener() {
                @Override
                public void onDataChange(DataSnapshot dataSnapshot) {
                    for (DataSnapshot deleteSnapshot: dataSnapshot.getChildren()) {
                        deleteSnapshot.getRef().child("usermob").setValue(mPhoneNumber);
                        updateProfile();

                        Toast.makeText(VerifyNumber.this,"Phone Number Changed to "+mPhoneNumber,Toast.LENGTH_LONG).show();

                        //Intent in = new Intent(VerifyNumber.this, MainAct.class);
                        //startActivity(in);
       ...
       /**     if (option.equals("signin")) {
                ...
                retreiveDetails.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        UserSession session = new UserSession(com.app.toado.activity.Account.VerifyNumber.this);
                        session.create_oldusersession(mobileKey.getUserkey());
                        startService(new Intent(com.app.toado.activity.Account.VerifyNumber.this, LocServ.class));
                        Intent in = new Intent(com.app.toado.activity.Account.VerifyNumber.this, MainAct.class);
                        ...
                        myxinstance = MyXMPP2.getInstance(com.app.toado.activity.Account.VerifyNumber.this, getString(R.string.server), mobileKey.getUserkey());
                ...
                try {
                    ...
                    Intent intent = new Intent(com.app.toado.activity.Account.VerifyNumber.this, ChooseAct.class);
    ...
    {
        Query deleteQuery = DBREF_USER_PROFILES.orderByChild("phone").equalTo(mPhoneNumber);

        deleteQuery.addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                for (DataSnapshot deleteSnapshot: dataSnapshot.getChildren()) {
                    deleteSnapshot.getRef().child("phone").setValue(mPhoneNumber);
