...
public class CallScreenActivity extends BaseActivity {
    ...
    ImageView endCallButton, speakerMode;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // endCallButton = (ImageView) findViewById(R.id.hangupButton);
        muteCall = (ImageView) findViewById(R.id.muteButton);
        speakerMode = (ImageView) findViewById(R.id.speakerMode);
        endCallButton = (ImageView) findViewById(R.id.hangupButton);
...
//            finish();
    ...
    public void muteCall(View view) {
        if (getSinchServiceInterface() != null) {
         ...
         //   System.out.println("aud from mutecall " + aud);
            ...
            if (muteCall.getDrawable().getConstantState().equals(ContextCompat.getDrawable(getApplicationContext(),R.drawable.muteoff).getConstantState())) {
                getSinchServiceInterface().getAudioController().mute();
                muteCall.setImageDrawable(ContextCompat.getDrawable(this, R.drawable.muteon));
            } else  if (muteCall.getDrawable().getConstantState().equals(ContextCompat.getDrawable(getApplicationContext(),R.drawable.muteon).getConstantState())) {
                getSinchServiceInterface().getAudioController().unmute();
                muteCall.setImageDrawable(ContextCompat.getDrawable(this, R.drawable.muteoff));
            }
        }
    }
    ...
    public void speakerMode(View view) {
        if (getSinchServiceInterface() != null) {
            ...
            if (speakerMode.getDrawable().getConstantState().equals(ContextCompat.getDrawable(getApplicationContext(),R.drawable.speakeroff).getConstantState())) {
                getSinchServiceInterface().getAudioController().enableSpeaker();
                speakerMode.setImageDrawable(ContextCompat.getDrawable(this, R.drawable.speakeron));
            } else  if (speakerMode.getDrawable().getConstantState().equals(ContextCompat.getDrawable(getApplicationContext(),R.drawable.speakeron).getConstantState())) {
                getSinchServiceInterface().getAudioController().disableSpeaker();
                speakerMode.setImageDrawable(ContextCompat.getDrawable(this, R.drawable.speakeroff));
            }
        }
    }
}
