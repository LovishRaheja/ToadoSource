            ...
            DBREF_USER_PROFILES.child(call.getRemoteUserId()).addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    if (dataSnapshot.exists()) {
                        ...
                        Glide.with(IncomingCallScreenActivity.this).load(u.getProfpicurl()).dontAnimate()
                                .transform(new CircleTransform(IncomingCallScreenActivity.this)).error(R.drawable.nouser).into(mCallImg);

                    } else {
                        remoteUser.setText(call.getHeaders().get("username"));
                        Glide.with(IncomingCallScreenActivity.this).load(call.getHeaders().get("profilepic")).dontAnimate()
                                .transform(new CircleTransform(IncomingCallScreenActivity.this)).error(R.drawable.nouser).into(mCallImg);
