...
public class NotifiMsgAdapter extends RecyclerView.Adapter<NotifiMsgAdapter.MyViewHolder> {
    ArrayList<String> list = new ArrayList<>();
    private Activity context;
    UserSession usess;
    public NotifiMsgAdapter(ArrayList<String> list, Activity context, UserSession usess) {
    ...
    @Override
    public NotifiMsgAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_settings, parent, false);
        return new NotifiMsgAdapter.MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(final NotifiMsgAdapter.MyViewHolder holder, int position) {
