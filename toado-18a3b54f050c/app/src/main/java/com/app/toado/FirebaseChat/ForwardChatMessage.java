...
public class ForwardChatMessage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_forward_chat_message);
        ...
        if (ForwardChatMessage.this.getIntent().getStringExtra("mykey") != null) {
      ...
      /**  if (msg.length() > 0) {
            ...
            newMessage.text = msg;
            newMessage.idSender = session.getUserKey();
            newMessage.idReceiver = userkey;
        ...
        mAdapter = new ForwardAdapter(list, this,"msg");
